...
|data.data.image                                    |           |docker-dev.production.deciphernow.com/deciphernow/gm-data:{{ .Values.data.version }}|
...
|data.data.envvars.client_jwt_endpoint_port.value   |           |{{- if .Values.global.spire.enabled }}10909{{- else}}10808{{- end }}                |
