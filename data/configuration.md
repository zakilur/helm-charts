...
Autogenerated by `gen-docs.py` at 2019-08-23 10:46:54
...
|data.envvars[20].value |{{ .Values.global.data.jwt_prefix }}                                                                   |
...
|data.envvars[23].value |{{ .Values.global.data.jwt_prefix }}                                                                   |
