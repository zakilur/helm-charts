        ...
        with open(os.path.join("./", svc, "values.yaml"), "r") as stream:
            try:
                ...
                sections = [
                   ...
                   {
                        "key": "internaldata",
                        "name": "### Internal Data Configuration",
                        "table": optionTableConfig,
                    },
                   {
                        "key": "internalmongo",
                        "name": "### Internal Mongo Configuration",
                        "table": optionTableConfig,
                    },
                   {
                        "key": "slo",
                   ...
                   {
                        "key": "internalredis",
                        "name": "### Internal Redis Configuration",
                        "table": optionTableConfig,
                    },
                   {
                        "key": "internaljwt",
                        "name": "### Internal JWT Configuration",
                        "table": optionTableConfig,
                    },
                   {
                        "key": "redis",
                    ...
                    },
                   {
                    ...
                    },
                    {
                        ...
                        "name": "### Edge Certificate Configuration",
                        "table": optionTableConfig,
                    },
                    {
                        "key": "controlApi",
